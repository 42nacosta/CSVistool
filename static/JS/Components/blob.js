...
import blobSound from '.bark.mp3';

const Blob = () => {
    const [showTextBubble, setShowTextBubble] = useState(false);
    const [tipIndex, setTipIndex] = useState(0);
    const [shouldPlaySound, setShoudPlaySound] = useState(false);
    ...
    const handleClick = () => {
        ...
        if (showtextBubble) {
            ...
            imgRef.current.classList.remove('bloblLogo-animate');
        }
